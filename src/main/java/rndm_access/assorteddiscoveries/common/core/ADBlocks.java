...
public class ADBlocks {
    ...
    public static final Block BLACK_CANDLE_RED_VELVET_CAKE = new ADCandleCakeBlock(RED_VELVET_CAKE, Blocks.BLACK_CANDLE,
            AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE));
    public static final Block JUNGLE_SNARE = new ADJungleSnareHeadBlock(AbstractBlock.Settings.copy(Blocks.VINE));
    public static final Block JUNGLE_SNARE_PLANT = new ADJungleSnareBodyBlock(AbstractBlock.Settings.copy(Blocks.VINE));
    ...
    public static void registerBlocks() {
        ...
        register("jungle_snare_plant", JUNGLE_SNARE_PLANT);
